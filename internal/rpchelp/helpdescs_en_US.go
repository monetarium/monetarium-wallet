...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--value": "decimal-coin string",
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount as the value, in VAR or in the coin denominated by cointype.",
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are CMGR, MONW, GRPC, LODR, MIXC, MIXP, PEER, RPCS, SYNC, TKBY, VSPC, and WLLT.\n" +
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (mond extension)",
