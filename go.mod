...
require (
	...
	github.com/monetarium/monetarium-node/container/lru v1.0.18 // indirect
	github.com/monetarium/monetarium-node/database v1.0.18 // indirect
	github.com/monetarium/monetarium-node/dcrec/edwards v1.0.18 // indirect
