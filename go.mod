...
require (
	...
	github.com/monetarium/monetarium-node/blockchain v1.1.0
	...
	github.com/monetarium/monetarium-node/certgen v1.1.0
	...
	github.com/monetarium/monetarium-node/crypto/blake256 v1.1.0
	github.com/monetarium/monetarium-node/crypto/rand v1.1.0
	github.com/monetarium/monetarium-node/crypto/ripemd160 v1.1.0
	github.com/monetarium/monetarium-node/dcrec v1.1.0
	github.com/monetarium/monetarium-node/dcrec/secp256k1 v1.1.0
	github.com/monetarium/monetarium-node/dcrjson v1.1.0
	github.com/monetarium/monetarium-node/dcrutil v1.1.0
	github.com/monetarium/monetarium-node/gcs v1.1.0
	github.com/monetarium/monetarium-node/hdkeychain v1.1.0
	github.com/monetarium/monetarium-node/mixing v1.1.0
